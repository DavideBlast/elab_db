...
\begin{document}
    ...
    \definecolor{LightCyan}{rgb}{0.88,1,1}
        ...
        \textbf{messaggi}(\underline{email}, \underline{idAnnuncio}, \underline{timestamp}, testo, mittente) \\
            ...
            \textbf{OP 2: Pubblicare un annuncio immobiliare (vendita o affitto)} \\
            \texttt{
                \textcolor{blue}{IF} (\textcolor{blue}{SELECT} * \\
                \textcolor{blue}{FROM} Immobili \\
                \textcolor{blue}{WHERE} Via = ? \textcolor{blue}{AND} NumeroCivico = ? \textcolor{blue}{AND} idCittà = ?) \textcolor{blue}{IS NOT NULL} \\
            } \\
            ...
            \texttt{
                ...
                \textcolor{blue}{FROM} Annunci\_Utente, Aste \\
                \textcolor{blue}{WHERE} StatoAnnuncio = 'Attivo'  \textcolor{blue}{AND} idCittà = ? \\
            ...
            \texttt{
                \textcolor{blue}{SELECT} * \\
                \textcolor{blue}{FROM} Annunci\_Utente, Aste \\
                \textcolor{blue}{WHERE} idCittà = ?  \textcolor{blue}{AND} StatoAnnuncio = 'Attivo'  \\
                \textcolor{blue}{AND} (Annunci\_Utente.TipoAnnuncioUtente = ?  \textcolor{blue}{OR} Aste.PrezzoMinimo \textcolor{blue}{IS NOT NULL}) \\
                \textcolor{blue}{ORDER BY} DataCreazione  \textcolor{blue}{DESC} \\
            }
            ...
            \texttt{
                ...
                \textcolor{blue}{WHERE} idCittà = ? \textcolor{blue}{AND} statoAnnuncio = 'Attivo' \textcolor{blue}{AND} metratura = ? \\
                \textcolor{blue}{UNION} \\
                \textcolor{blue}{SELECT} * \\
            ...
            \texttt{
                \textcolor{blue}{SELECT} * \\
                \textcolor{blue}{FROM} Annunci\_Utente, Aste \\
                \textcolor{blue}{WHERE} idZona = ?   \textcolor{blue}{AND} StatoAnnuncio = 'Attivo' \\
                \textcolor{blue}{ORDER BY} DataCreazione   \textcolor{blue}{DESC} \\
            }
            ...
            \texttt{
                \textcolor{blue}{SELECT} * \\
                \textcolor{blue}{FROM} Annunci\_Utente A  \textcolor{blue}{JOIN} Immobili I  \textcolor{blue}{ON} (A.idImmobile = I.idImmobile) \\
                \textcolor{blue}{WHERE} idCittà = ?  \textcolor{blue}{AND} statoAnnuncio = 'Attivo'  \\
                \textcolor{blue}{AND} I.tipoImmobile = 'Stanza'  \textcolor{blue}{AND} numeroConquilini <= ? \\
                \textcolor{blue}{ORDER BY} DataCreazione  \textcolor{blue}{DESC} \\
            }
            ...
            \textbf{OP 15: Andamento del prezzo di un immobile in funzione del tempo} \\
            \texttt{
                \textcolor{blue}{SELECT} dataCreazione, prezzo \\
                \textcolor{blue}{FROM} Annunci\_Utente A \\
                \textcolor{blue}{WHERE} A.idImmobile = ? \textcolor{blue}{AND} A.tipoAnnuncio = 'Vendita' \\
                \textcolor{blue}{ORDER BY} DataCreazione \textcolor{blue}{DESC} \\
            }
            ...
            \textbf{OP 16: Comparare il prezzo di un immobile al mq con quello degli immobili nella stessa zona} \\
            \texttt{
                \textcolor{blue}{SELECT} idAnnuncio, (prezzo-costoMedioMq) * 100/costoMedioMq \\
            ...
            \textbf{OP 22: Ordinare le città in base a valori specifici di una o più categorie} \\
            \texttt{
                \textcolor{blue}{SELECT} A.percentualeSpazioVerdeUrbano, A.idCittà, C.nome, C.anno, C.idCittà \\
                \textcolor{blue}{FROM} Ambiente A, Città\_Anni C \\
                \textcolor{blue}{WHERE} A.idCittà = C.idCittà  \\
